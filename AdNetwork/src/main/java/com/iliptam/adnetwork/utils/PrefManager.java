...
/**
 * Created by iliptam on 15/12/2021.
 */
...
public class PrefManager {
    ...
    private static final String PREF_NAME = "adnetwork";
    ...
    public void setImpration(String PREF_NAME,int VAL) {
        editor.putInt(PREF_NAME, VAL);
        editor.commit();
    }
    public void setClick(String PREF_NAME,int VAL) {
        editor.putInt(PREF_NAME, VAL);
        editor.commit();
    }
    ...
    public int getImpration(String key) {
        return pref.getInt(key,0);
    }
    public int getClick(String key) {
        return pref.getInt(key,0);
    }
}
